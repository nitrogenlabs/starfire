...
function printChildren(path, options, print, events) {
  ...
  path.map((childPath, index) => {
    ...
    if(result !== false) {
      starfireIgnore = isStarfireIgnore(childNode);
...
function isStarfireIgnore(node) {
  return (
...
function shouldPrePrintDoubleHardline(node, data) {
  ...
  const isPrevNodeStarfireIgnore = isStarfireIgnore(data.prevNode);
...
module.exports = {
  ...
  hasStarfireIgnore: privateUtil.hasIgnoreComment
};
